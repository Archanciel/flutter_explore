...
// typedef ToJsonFunction<T> = Map<String, dynamic> Function(T model);
  ...
  static T decodeJson<T>(String jsonString, Type type) {
    ...
    if (fromJsonFunction != null) {
      ...
      if (jsonData is List) {
        ...
        return fromJsonFunction(jsonData) as T;
      }
    }
...
void main() {
  ...
  // testing JsonDataService.encodeJson()
  ...
  // testing JsonDataService.decodeJson()

  MyClass myClassDecodedInstance =
      JsonDataService.decodeJson<MyClass>(myClassJsonStr, MyClass);
  print('myClassDecodedInstance: $myClassDecodedInstance');

  MyOtherClass myOtherClassDecodedInstance =
      JsonDataService.decodeJson<MyOtherClass>(
